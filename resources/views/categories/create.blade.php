      ...
      <div class="row">
        ...
        <div class="card card-primary col-sm-12">
          <div class="card-header">
            <h3 class="card-title">Create a New Category (for products)</h3>
          ...
          <div class="card-body col-sm-6">
            <form action="{{ route('categories.store') }}" method="post" id="categories_create"> @csrf
                <label for="name">Category Name</label>
              <div class="form-group row">
                    <div class="col-sm-10">
                      <input type="text" value="{{ old('name') }}" class="form-control" id="name" name='name' placeholder="Enter a name for this new category">
                    </div>
                    @error('name')
