      ...
      @endif -->
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"> <a href="{{ route('categories.index') }}"> View All Categories</a></li>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="cursor:progress" class="d-flex">
                      <div class="mr-1">
                        <a class="btn btn-sm btn-info" href="{{ route('categories.edit', $cat->id) }}"> Edit </a>

                      </div>
                      <form method="post" action="{{ route('categories.destroy', $cat->id) }}">@csrf
                        @method('DELETE')
