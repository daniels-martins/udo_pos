            ...
            <div class="card-body">
              <form class="form-horizontal" action={{ route("password.modify") }} method='post'> @csrf
                <div class=''>
                  ...
                  <div class="form-group row">
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="tag" name='tag' placeholder="Enter product tags" value='{{ $product->tags }}'>
                  ...
                  <div class="form-group row">
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="category" name='category' placeholder="Enter product category" value='{{ $product->tags }}' />
                  ...
                  <div class="form-group row">
                    <div class="col-sm-10 d-flex">
                      <div class="col-sm-6">
                        <input type="number" class="form-control" id="qty" name='qty' placeholder="Enter quantity of product purchased or in stock" value='{{ $product->qty }}'>
