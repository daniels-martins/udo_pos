            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab" title='A brief history of all store activities'>Activity</a></li>
                  <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab" title='A brief history of all my activities'>Timeline</a></li>
