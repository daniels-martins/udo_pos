      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary ">
            ...
            <div class="card-body">
              <form class="form-horizontal" action={{ route("employees.store") }} method='post'> @csrf
                ...
                <div class="form-group row">
                  <div class="col-sm-10">
                    ...
                    <div class="text-info text-sm">Employee Store</div>
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-10">
                    <input type="text" value="{{ old('username') }}" class="form-control" id="name" name='username' placeholder="Enter Employee Name">
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-10">
                    <input type="text" value="{{ old('fname') }}" class="form-control" id="fname" name='fname' placeholder="Enter Employee First Name">
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-10">
                    <input type="text" value="{{ old('lname') }}" class="form-control" id="lname" name='lname' placeholder="Enter Employee Last Name">
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-10">
                    <input type="email" value="{{ old('email') }}" class="form-control" id="email" name='email' placeholder="Enter Employee email">
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-10">
                    <input type="text" value="{{ old('mobile') }}" class="form-control" id="mobile" name='mobile' placeholder="Enter Employee Mobile Phone">
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-10">
                    <input type="text" value="{{ old('mobile') }}" class="form-control" id="phone" name='phone' placeholder="Enter Employee secondary phone number">
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-10">
                    <input type="text" value="{{ old('shipping_address') }}" class="form-control" id="shipping_address" name='shipping_address' placeholder="Enter Employee Shop address">
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-10">
                    <input type="text" value="{{ old('billing_address') }}" class="form-control" id="billing_address" name='billing_address' placeholder="Enter Employee Billing/House address">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  @error('Employee is currently owing me money ? ')
                  <div class="col-sm-10 ml-1 text-danger">{{ $message }}</div>
                  @enderror
                </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-10">
                    ...
                    <textarea name="notes" id="notes" cols="40" rows="5" placeholder="Enter notes for this employee -- Remember them when next they come"></textarea>
                  </div>
                  @error('billing_address')
                  <div class="col-sm-10 ml-1 text-danger">{{ $message }}</div>
                  @enderror
                ...
                <div class="card-footer mt-5">
                  <button type="submit" class="btn btn-primary inline-block">Create Employee</button>
