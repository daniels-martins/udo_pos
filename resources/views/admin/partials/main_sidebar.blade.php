        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                @unless (Auth::user()->firm()->count())
                <li class="nav-item">
                  <a href="{{ route('firms.create') }}" class="nav-link custom-link ">
                    <i class="fas fa-plus-circle nav-icon"></i>
                    <p>Add a business or Company </p>
                  </a>
                </li>
                @else
                <li class="nav-item">
                  <a href="{{ route('firms.show', Auth::user()->firm->id ?? 'zero') }}" class="nav-link custom-link ">
                    <i class="fas fa-plus-circle nav-icon"></i>
                    <p>View Company </p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  <a  href="{{ route('firms.edit', Auth::user()->firm->id ?? 'zero') }}" class="nav-link custom-link ">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('invoices.create') }}" class="nav-link custom-link ">
                    <i class="fas fa-plus-circle nav-icon"></i>
                    <p>Add Invoice </p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('invoices.index') }}" class="nav-link custom-link ">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              ...
              <a href="{{ route('pos') }}" class="nav-link custom-link ">
