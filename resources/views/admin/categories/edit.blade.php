      ...
      <div class="row">
        ...
        <div class="card card-primary col-sm-12">
          ...
          <div class="card-body col-sm-6">
            <form action="{{ route('categories.update', $category->id) }}" method="post" id="categories_update"> @csrf @method('patch')
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-primary inline-block" form="categories_update">Update Category</button>
